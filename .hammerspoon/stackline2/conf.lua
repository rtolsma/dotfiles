...
-- Appearance
c.appearance.color                    = { white = 0.03 }    -- Indicator background color, e.g., {red = 0.5, blue = 0 }
...
c.appearance.iconDimmer               = 1.2                 -- Higher numbers dim inactive icons *less* than the non-icon indicators
c.appearance.showIcons                = false                -- Window indicator style ('lozenge'-shaped when false)
c.appearance.size                     = 60                  -- Size of window indicators (height when icons off)
c.appearance.radius                   = 4                  -- Indicator roundness. Higher numbers → *less* roundness… I'm sorry
...
c.appearance.screenPadding			  = 8					-- Distance from side of screen to pad by
...
c.appearance.offset.y                 = 100                   -- Distance from top of the window to render indicators
c.appearance.offset.x                 = 10                  -- Distance away from the edge of the window to render indicators
